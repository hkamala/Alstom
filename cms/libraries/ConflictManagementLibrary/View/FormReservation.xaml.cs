        ...
        public class ReservationDataGenerator
        {
            public static List<Reservation> GenerateReservations(IMyLogger logger)
            {
                return new List<Reservation>
                {
                    ...
                    new Reservation(logger) { MyStationName = "StationName5", MyNodeNumber = "05", MyLinkReferenceUid = "02uidL", MyEdgeUid = "02-EDG", RouteName = "SmplRteName", BeginPlatform = "SmplBgnPlf", EndPlatform = "SmplEndPlatform", MyTripStartTime = "06/07/24 08:36", MyTripEndTime = "06/07/24 18:40", TotalTimeInSeconds = "50100", DwellTimeinSeconds = "50100"},
                    new Reservation(logger) { MyStationName = "StationName6", MyNodeNumber = "06", MyLinkReferenceUid = "03uidL", MyEdgeUid = "03-EDG", RouteName = "SmplRteName", BeginPlatform = "SmplBgnPlf", EndPlatform = "SmplEndPlatform", MyTripStartTime = "06/08/24 23:07", MyTripEndTime = "06/08/24 06:13", TotalTimeInSeconds = "60840", DwellTimeinSeconds = "60840"},
                    new Reservation(logger) { MyStationName = "StationName7", MyNodeNumber = "07", MyLinkReferenceUid = "04uidL", MyEdgeUid = "04-EDG", RouteName = "SmplRteName", BeginPlatform = "SmplBgnPlf", EndPlatform = "SmplEndPlatform", MyTripStartTime = "06/08/24 12:56", MyTripEndTime = "06/08/24 16:43", TotalTimeInSeconds = "13620", DwellTimeinSeconds = "13620"},
                    new Reservation(logger) { MyStationName = "StationName8", MyNodeNumber = "08", MyLinkReferenceUid = "02uidL", MyEdgeUid = "02-EDG", RouteName = "SmplRteName", BeginPlatform = "SmplBgnPlf", EndPlatform = "SmplEndPlatform", MyTripStartTime = "06/07/24 08:36", MyTripEndTime = "06/07/24 18:40", TotalTimeInSeconds = "50100", DwellTimeinSeconds = "50100"},
                    new Reservation(logger) { MyStationName = "StationName9", MyNodeNumber = "09", MyLinkReferenceUid = "03uidL", MyEdgeUid = "03-EDG", RouteName = "SmplRteName", BeginPlatform = "SmplBgnPlf", EndPlatform = "SmplEndPlatform", MyTripStartTime = "06/08/24 23:07", MyTripEndTime = "06/08/24 06:13", TotalTimeInSeconds = "60840", DwellTimeinSeconds = "60840"},
                    new Reservation(logger) { MyStationName = "StationName10", MyNodeNumber = "10", MyLinkReferenceUid = "04uidL", MyEdgeUid = "04-EDG", RouteName = "SmplRteName", BeginPlatform = "SmplBgnPlf", EndPlatform = "SmplEndPlatform", MyTripStartTime = "06/08/24 12:56", MyTripEndTime = "06/08/24 16:43", TotalTimeInSeconds = "13620", DwellTimeinSeconds = "13620"},
                };
            }
        }
    }
